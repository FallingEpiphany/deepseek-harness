...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.mcpConnections` | `core` | [`mcp-client`](../packages/mcp/mcp-client) | - | - | - | Companion plugins resolve authenticated resources and prompts in their existing tool scope without copying credentials. |
